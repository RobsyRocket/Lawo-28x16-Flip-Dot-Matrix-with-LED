...
F 1 "22K" V 2100 4000 50  0000 C CNN
...
U 1 1 574E0790
P 2200 4700
F 0 "C3" H 2225 4800 50  0000 L CNN
F 1 "0.22uF" H 2225 4600 50  0000 L CNN
...
U 1 1 574E07E1
P 2550 1300
F 0 "C2" H 2575 1400 50  0000 L CNN
...
U 1 1 574E0815
P 1500 3700
F 0 "C4" H 1525 3800 50  0000 L CNN
F 1 "4.7uF" H 1525 3600 50  0000 L CNN
F 2 "Capacitors_ThroughHole:C_Rect_L7_W2_P5" H 1538 3550 50  0001 C CNN
...
F 1 "VSS" H 7800 1600 50  0000 C CNN
...
F 1 "VCC" H 7750 2150 50  0000 C CNN
...
A1
Text GLabel 8600 2400 0    60   BiDi ~ 0
RESET_01
...
RESET_10
Text GLabel 8600 3400 0    60   BiDi ~ 0
RESET_11
...
F 3 "" H 7800 2350 50  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 10100 2400 2    60   BiDi ~ 0
SET_01
Text GLabel 10100 2500 2    60   BiDi ~ 0
SET_02
Text GLabel 10100 2600 2    60   BiDi ~ 0
SET_03
Text GLabel 10100 2700 2    60   BiDi ~ 0
SET_04
...
F 1 "VSS" H 10750 1650 50  0000 C CNN
...
F 1 "VCC" H 10750 1850 50  0000 C CNN
...
Wire Wire Line
	9600 2300 10750 2300
Wire Wire Line
	9600 2800 10100 2800
Wire Wire Line
	10950 1600 9600 1600
Wire Wire Line
	9600 1700 10750 1700
Wire Wire Line
	10750 1500 9600 1500
...
U 1 1 5CE18C31
P 9300 2700
F 0 "J2" H 9350 4117 50  0000 C CNN
F 1 "Conn_02x25_Counter_Clockwise" H 9350 4026 50  0000 C CNN
F 2 "Connectors_IDC:IDC-Header_2x25_Pitch2.54mm_Straight" H 9300 2700 50  0001 C CNN
...
U 1 1 5C58080C
P 6300 2700
F 0 "J1" H 6350 4117 50  0000 C CNN
...
F 1 "Conn_01x02" H 4980 4751 50  0000 L CNN
...
U 1 1 5CE7C729
P 6250 4850
F 0 "J4" H 6330 4842 50  0000 L CNN
F 1 "Conn_01x02" H 6330 4751 50  0000 L CNN
...
F 1 "VCC" H 5767 5373 50  0000 C CNN
...
U 1 1 5CF58157
P 1150 3700
F 0 "C1" H 1175 3800 50  0000 L CNN
F 1 "0.1uF" H 1175 3600 50  0000 L CNN
F 2 "Capacitors_ThroughHole:C_Rect_L7_W2_P5" H 1188 3550 50  0001 C CNN
...
Wire Wire Line
	8000 2300 9100 2300
Text Notes 5000 4400 2    120  ~ 0
LEDs
Text Notes 4550 6450 0    90   Italic 0
ToDo:\n- review mapping of the enable pins\n- review naming of the enable pins (mayb align with ones of Lawo 28x13)\n- review which connector receives the incomming signals and which goes to the next module\n- add more rating details about the mounted capacitors, resistors and LEDs\n- add schematic for the LED wiring\n- measure LED voltage level and fix schematic
$EndSCHEMATC
